...
class User < ActiveRecord::Base
  ...
  has_many :friends, inverse_of: :requesting_user, dependent: :destroy
  has_many :friends, inverse_of: :requested_user, dependent: :destroy
  has_many :friend_requests, inverse_of: :requesting_user, dependent: :destroy
